 ...
 * "JG" one (suffix "SW"), so both can be browsed and A/B'd on the device.
 *
 * ---------------------------------------------------------------------------
...
export default [
  ...
  { cat: "BS", tag: "SW", name: "Nightdrive", fx: [SWFX.chorus, SWFX.air, SWFX.tick],
  ...
  { cat: "BS", tag: "SW", name: "Outrun", fx: [SWFX.chorusWide, SWFX.room, SWFX.sixteenth],
  ...
  { cat: "BS", tag: "SW", name: "Acid Drive", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...BASS, ...BLIP(84, 14),
  ...
  { cat: "BS", tag: "SW", name: "Reso Stab", fx: [SWFX.snap, SWFX.tick],
    p: { ...BASS, ...BLIP(90, 10),
  ...
  { cat: "BS", tag: "SW", name: "FM Growl", fx: [SWFX.chamber, SWFX.tick],
  ...
  { cat: "BS", tag: "SW", name: "Ring Bass", fx: [SWFX.chorus, SWFX.snap, SWFX.tick],
  ...
  { cat: "BS", tag: "SW", name: "Moog Sub", fx: [SWFX.air, SWFX.tick],
    p: { ...BASS, ...BLIP(58, 30),
  ...
  { cat: "BS", tag: "SW", name: "PWM Bass", fx: [SWFX.chorusWide, SWFX.room, SWFX.slap],
  ...
  { cat: "BS", tag: "SW", name: "Sync Bass", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...BASS, ...BLIP(80, 20, 3),
  ...
  { cat: "BS", tag: "SW", name: "Tape Sub", fx: [SWFX.chorus, SWFX.murk, SWFX.tape],
  ...
  { cat: "BS", tag: "SW", name: "Gated Bass", fx: [SWFX.snap, SWFX.sixteenth],
  ...
  { cat: "BS", tag: "SW", name: "Crush Bass", fx: [SWFX.chamber, SWFX.tick],
  ...
  { cat: "LD", tag: "SW", name: "Neon", fx: [SWFX.chorusWide, SWFX.plate, SWFX.dotted],
  ...
  { cat: "LD", tag: "SW", name: "Sync Scream", fx: [SWFX.snap, SWFX.triplet],
  ...
  { cat: "LD", tag: "SW", name: "Hero Saw", fx: [SWFX.chorusWide, SWFX.hall, SWFX.dotted],
  ...
  { cat: "LD", tag: "SW", name: "Glass Bell", fx: [SWFX.chorus, SWFX.cavern, SWFX.triplet],
  ...
  { cat: "LD", tag: "SW", name: "PWM Lead", fx: [SWFX.chorusDeep, SWFX.plate, SWFX.eighth],
  ...
  { cat: "LD", tag: "SW", name: "Whistle", fx: [SWFX.chorus, SWFX.hall, SWFX.dotted],
  ...
  { cat: "LD", tag: "SW", name: "Acid Lead", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...MONO, ...BLIP(88, 16),
  ...
  { cat: "LD", tag: "SW", name: "Ring Lead", fx: [SWFX.chorus, SWFX.snap, SWFX.triplet],
  ...
  { cat: "LD", tag: "SW", name: "Chime", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.wide],
  ...
  { cat: "LD", tag: "SW", name: "Drive Lead", fx: [SWFX.chamber, SWFX.eighth],
  ...
  { cat: "LD", tag: "SW", name: "Detune Stack", fx: [SWFX.chorusWide, SWFX.hall, SWFX.wide],
  ...
  { cat: "LD", tag: "SW", name: "S+H Lead", fx: [SWFX.snap, SWFX.sixteenth],
  ...
  { cat: "LD", tag: "SW", name: "Vox Lead", fx: [SWFX.chorusDeep, SWFX.plate, SWFX.dotted],
  ...
  { cat: "LD", tag: "SW", name: "Crush Lead", fx: [SWFX.snap, SWFX.triplet],
  ...
  { cat: "PD", tag: "SW", name: "Neon Wash", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Warm Drift", fx: [SWFX.chorus, SWFX.hall, SWFX.tape],
  ...
  { cat: "PD", tag: "SW", name: "Glass Pad", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.triplet],
  ...
  { cat: "PD", tag: "SW", name: "Sweep Pad", fx: [SWFX.chorusDeep, SWFX.hall, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Choir", fx: [SWFX.chorusWide, SWFX.cathedral, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Dark Drift", fx: [SWFX.chorus, SWFX.murk, SWFX.tape],
  ...
  { cat: "PD", tag: "SW", name: "Shimmer", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.triplet],
  ...
  { cat: "PD", tag: "SW", name: "Sync Pad", fx: [SWFX.chorusDeep, SWFX.hall, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Ring Pad", fx: [SWFX.chorusWide, SWFX.cathedral, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Strings", fx: [SWFX.chorusWide, SWFX.hall, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Cold Air", fx: [SWFX.chorus, SWFX.cavern, SWFX.wide],
  ...
  { cat: "PD", tag: "SW", name: "Crush Pad", fx: [SWFX.chorusDeep, SWFX.murk, SWFX.tape],
  ...
  { cat: "KB", tag: "SW", name: "Tine EP", fx: [SWFX.chorusWide, SWFX.chamber, SWFX.slap],
  ...
  { cat: "KB", tag: "SW", name: "Bell Keys", fx: [SWFX.chorus, SWFX.cavern, SWFX.triplet],
    p: { ...POLY, ...BLIP(72, 18, 5),
  ...
  { cat: "KB", tag: "SW", name: "Bright EP", fx: [SWFX.chorusWide, SWFX.plate, SWFX.eighth],
  ...
  { cat: "KB", tag: "SW", name: "Clav", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...POLY, ...BLIP(84, 12),
  ...
  { cat: "KB", tag: "SW", name: "Organ", fx: [SWFX.chorusDeep, SWFX.chamber, SWFX.slap],
  ...
  { cat: "KB", tag: "SW", name: "Glass Keys", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.wide],
  ...
  { cat: "KB", tag: "SW", name: "Pluck Keys", fx: [SWFX.chorus, SWFX.snap, SWFX.eighth],
    p: { ...POLY, ...BLIP(78, 16),
  ...
  { cat: "KB", tag: "SW", name: "Toy Piano", fx: [SWFX.chorus, SWFX.snap, SWFX.tick],
    p: { ...POLY, ...BLIP(80, 12, 5),
  ...
  { cat: "KB", tag: "SW", name: "Vintage EP", fx: [SWFX.chorusWide, SWFX.plate, SWFX.tape],
  ...
  { cat: "KB", tag: "SW", name: "Reso Keys", fx: [SWFX.chorusDeep, SWFX.chamber, SWFX.dotted],
  ...
  { cat: "ARP", tag: "SW", name: "Acid Run", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...MONO, ...BLIP(88, 14),
  ...
  { cat: "ARP", tag: "SW", name: "Bright Steps", fx: [SWFX.chorus, SWFX.snap, SWFX.sixteenth],
    p: { ...POLY, ...BLIP(76, 14),
  ...
  { cat: "ARP", tag: "SW", name: "PWM Seq", fx: [SWFX.chorusWide, SWFX.room, SWFX.eighth],
  ...
  { cat: "ARP", tag: "SW", name: "S+H Grid", fx: [SWFX.snap, SWFX.triplet],
  ...
  { cat: "ARP", tag: "SW", name: "FM Steps", fx: [SWFX.chorus, SWFX.chamber, SWFX.sixteenth],
    p: { ...POLY, ...BLIP(70, 16, 5),
  ...
  { cat: "ARP", tag: "SW", name: "Octave Run", fx: [SWFX.chorusWide, SWFX.plate, SWFX.eighth],
  ...
  { cat: "ARP", tag: "SW", name: "Sync Grid", fx: [SWFX.snap, SWFX.sixteenth],
    p: { ...MONO, ...BLIP(82, 16, 3),
  ...
  { cat: "ARP", tag: "SW", name: "Glass Grid", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.triplet],
  ...
  { cat: "ARP", tag: "SW", name: "Ring Steps", fx: [SWFX.chorus, SWFX.snap, SWFX.triplet],
  ...
  { cat: "ARP", tag: "SW", name: "Crush Run", fx: [SWFX.snap, SWFX.sixteenth],
  ...
  { cat: "FX", tag: "SW", name: "Riser", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.wide],
  ...
  { cat: "FX", tag: "SW", name: "Downlift", fx: [SWFX.chorusDeep, SWFX.murk, SWFX.tape],
  ...
  { cat: "FX", tag: "SW", name: "Ring Sweep", fx: [SWFX.chorusWide, SWFX.cathedral, SWFX.wide],
  ...
  { cat: "FX", tag: "SW", name: "Noise Wash", fx: [SWFX.chorusWide, SWFX.cavern, SWFX.wide],
  ...
  { cat: "FX", tag: "SW", name: "Sync Zap", fx: [SWFX.snap, SWFX.triplet],
    p: { ...MONO, ...BLIP(92, 10, 3),
         osc1_wave: 0, osc2_wave: 0, osc2_vol: 74, osc2_tune: st(7), osc_sync: 1,
  ...
  { cat: "FX", tag: "SW", name: "Drone", fx: [SWFX.chorusDeep, SWFX.cathedral, SWFX.wide],
