...
var PAGES = [
  ...
  { name: "FILTER", cells: [
    ...
    P("keyfollow",  "Kfol",  "pct"),
    P("filter_env", "EnvA",  "pct"),
    P("highpass",   "HP",    "pct"),
    P("vel_cut",    "VCut",  "pct"),
  ...
  { name: "A.ENV", cells: [
    ...
    P("voices",    "Voice", "int", { min: 1, max: 6 }),
  ]},
  { name: "LFO 1", cells: [
    ...
    P("lfo1_keytrig","KTrg",  "toggle", { opts: ONOFF }),
  ...
  { name: "LFO 2", cells: [
    ...
    P("lfo2_keytrig","KTrg",  "toggle", { opts: ONOFF }),
  ...
  { name: "FX", cells: [
    P("chorus1",     "Ch1",   "toggle", { opts: ONOFF }),
    P("chorus2",     "Ch2",   "toggle", { opts: ONOFF }),
